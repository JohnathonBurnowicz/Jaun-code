...
public class Arm extends SubsystemBase {
  ...
  public Arm() {
    ...
    leftArmMotor.setSoftLimit(SoftLimitDirection.kForward, 190);
    ...
    rightArmMotor.setSoftLimit(SoftLimitDirection.kForward, 190);
    rightArmMotor.enableSoftLimit(SoftLimitDirection.kReverse, true);
    rightArmMotor.setSoftLimit(SoftLimitDirection.kReverse, -1);

...
public class FeederTurret extends SubsystemBase {
  ...
  private final SparkMaxPIDController pid = left.getPIDController();
...
//    System.out.println("Shooter constructor called");
    ...
    left.setOpenLoopRampRate(1);
    left.setClosedLoopRampRate(1);
